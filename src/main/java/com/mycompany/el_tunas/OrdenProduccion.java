...
//        DetalleProducto detalleProducto = new DetalleProducto();
    ...
    public  OrdenProduccion crearOrdenProduccion (Integer noOrden, List<Producto> productosCatalogo, Cliente cliente){
    ...
    public void terminarOrdenes ( List<OrdenProduccion> ordenesProduccion,List<Producto> productosCatalogo){
         Scanner sp = new Scanner (System.in);
        int i = 1;
        int numero;
